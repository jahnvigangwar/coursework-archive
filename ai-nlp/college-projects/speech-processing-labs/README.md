...
Notebooks for speech and audio feature processing; sample audio is not copied.

This is a curated coursework snapshot consolidated from [`jahnvigangwar/SpeechProcessing`](https://github.com/jahnvigangwar/SpeechProcessing) on the `main` branch. The original repository is the source of full setup notes and Git history.
