...
Notebook experiments; document datasets, evaluation, and privacy considerations before use.

This is a curated coursework snapshot consolidated from [`jahnvigangwar/Emotion-recognition`](https://github.com/jahnvigangwar/Emotion-recognition) on the `main` branch. The original repository is the source of full setup notes and Git history.
