...
A small web scraping exercise; proxy configuration is not copied.

This is a curated coursework snapshot consolidated from [`jahnvigangwar/web-Scraping-`](https://github.com/jahnvigangwar/web-Scraping-) on the `main` branch. The original repository is the source of full setup notes and Git history.
