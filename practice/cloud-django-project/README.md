# Cloud Django project.

A Django learning project; local database and generated framework files are excluded.

This is a curated coursework snapshot consolidated from [`jahnvigangwar/cloud_django`](https://github.com/jahnvigangwar/cloud_django) on the `main` branch. The original repository is the source of full setup notes and Git history.
