...
A Django course project; local database and generated framework files are excluded.

This is a curated coursework snapshot consolidated from [`jahnvigangwar/django_final`](https://github.com/jahnvigangwar/django_final) on the `master` branch. The original repository is the source of full setup notes and Git history.
