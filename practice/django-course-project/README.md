...
This is a curated coursework snapshot consolidated from [`jahnvigangwar/Django-project`](https://github.com/jahnvigangwar/Django-project) on the `master` branch. The original repository is the source of full setup notes and Git history.
