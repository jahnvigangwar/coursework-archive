# Flask course exercises.

A collection of Flask exercises; virtual environments and local databases are excluded.

This is a curated coursework snapshot consolidated from [`jahnvigangwar/Flask`](https://github.com/jahnvigangwar/Flask) on the `main` branch. The original repository is the source of full setup notes and Git history.
