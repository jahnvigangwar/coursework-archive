...
Small C++ programming exercises and problem-solving examples.

This is a curated coursework snapshot consolidated from [`jahnvigangwar/CPP`](https://github.com/jahnvigangwar/CPP) on the `main` branch. The original repository is the source of full setup notes and Git history.
