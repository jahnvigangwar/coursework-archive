# Deep learning CNN exercise.

A notebook-based convolutional neural network exercise.

This is a curated coursework snapshot consolidated from [`jahnvigangwar/Deep-Learning-CNN-`](https://github.com/jahnvigangwar/Deep-Learning-CNN-) on the `main` branch. The original repository is the source of full setup notes and Git history.
