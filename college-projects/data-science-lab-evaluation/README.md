...
Notebook-based data science coursework; the source dataset is not copied.

This is a curated coursework snapshot consolidated from [`jahnvigangwar/Acc-DS-labEval2`](https://github.com/jahnvigangwar/Acc-DS-labEval2) on the `main` branch. The original repository is the source of full setup notes and Git history.
