...
//drawing the two pipes with outerline
{
...
void check()
{
 ...
 {
 scr(); //calculate the score at last
 menu();
 games++;
 flag=0;
 flag2=0;
...
output(100,150,"VtuCs.com");
 output(100,100,"From Bits to Bytes, all about Computer Science");
}
void scores()
{
bg();
