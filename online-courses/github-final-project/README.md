# Git and GitHub peer-evaluation final project.

A short course capstone focused on Git and GitHub workflow.

This is a curated coursework snapshot consolidated from [`jahnvigangwar/github-final-project`](https://github.com/jahnvigangwar/github-final-project) on the `main` branch. The original repository is the source of full setup notes and Git history.
